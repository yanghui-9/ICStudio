...
extern "C"
{
   ...
   *  -- 失败，返回 Protocol_Rtn_Fail
   */
   PROTOCOLSHARED_EXPORT int32_t SetRegValueChangeCallback(const std::vector<Protocol::AddrInfoForRW> &addrVec, Protocol::Add_Type addType, const Protocol::DataCallback &callback);
