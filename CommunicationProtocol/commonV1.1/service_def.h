...
struct AddrInfo
{
    ...
    uint64_t beginIndex = 0;//解析数据部分开始索引.
    uint64_t dataLen = 0;//解析数据的长度.
...
{
    //绑定地址值变化.
    Protocol::AddrInfoForRW valueChangeAddrInfo;
    ...
    Addr_Change_Data(const Protocol::AddrInfoForRW &var):valueChangeAddrInfo(var)
    {
